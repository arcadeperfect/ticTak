class GameLogic(object):
    ...
    def check_for_win(self, x=None, y=None, vx=None, vy=None, player=None):
                ...
                if cell_1:
                    ...
                    for i in self.get_neighbors(x, y):
                        ...
                        if cell_2 == cell_1:
                            vx = x2 - x
                            vy = y2 - y
                            return self.check_for_win(x2, y2, vx, vy, cell_1)
        ...
        # if params are specified, keep checking in that direction based on the vector
            ...
            if cell_1 == player:
                ...
                if self.within_board(x2, y2):
                    return self.check_for_win(x2, y2, vx, vy, player)
                else:
...
if __name__ == "__main__":
    ...
    game.set_player_1(0,0)
    game.update()
    game.set_player_1(0,1)
    game.update()
    game.set_player_1(0,3)
    game.update()
